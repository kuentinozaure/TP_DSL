...
import com.m1ice.fsm.dsl.formatting2.MyDslFormatter;
import com.m1ice.fsm.dsl.generator.MyDslGenerator;
import com.m1ice.fsm.dsl.parser.antlr.MyDslAntlrTokenFileProvider;
import com.m1ice.fsm.dsl.parser.antlr.MyDslParser;
import com.m1ice.fsm.dsl.parser.antlr.internal.InternalMyDslLexer;
import com.m1ice.fsm.dsl.scoping.MyDslScopeProvider;
import com.m1ice.fsm.dsl.serializer.MyDslSemanticSequencer;
import com.m1ice.fsm.dsl.serializer.MyDslSyntacticSequencer;
import com.m1ice.fsm.dsl.services.MyDslGrammarAccess;
import com.m1ice.fsm.dsl.validation.MyDslConfigurableIssueCodesProvider;
import com.m1ice.fsm.dsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "com/m1ice/fsm/dsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("com.m1ice.fsm.dsl.MyDsl");
	}
